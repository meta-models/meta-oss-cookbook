...
Example agents that show what Muse Glimmer does best: plan, call tools, execute, and self-correct — fully offline, on the GPU you already own.


| Recipe | What it proves |
|---|---|
| [structured-output/](structured-output/) | Unstructured text in, typed object out — schema enforced by the server |
...
| [voice-agent-macos/](voice-agent-macos/) | A complete local voice conversation stack using ExecuTorch for speech recognition, Muse Glimmer generation, and speech synthesis on Apple silicon |
